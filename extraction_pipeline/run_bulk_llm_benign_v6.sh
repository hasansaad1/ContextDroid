#!/usr/bin/env bash
# Full benign dataset (284 APKs) with Phase 1–3; Ollama on execute (engine-only off by default).
# Prior runs preserved: logs/bulk_llm_dataset/, logs/bulk_llm_pilot_v5/, etc.
#
# Usage (repo root):
#   bash extraction_pipeline/run_bulk_llm_benign_v6.sh [duration_sec]
#
# Logs: logs/bulk_llm_benign_v6/
# APK set: data/apks/benign/
...
LOG_DIR="${BASE_DIR}/logs/bulk_llm_benign_v6"
